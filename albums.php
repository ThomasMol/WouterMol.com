...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top atTop">
        <div class="container">
    ...
    <section id="main">
        <div class="jumbotron albums">
            <div class="container">
                ...
                <h2 id="sub-message">Gallery of albums</h2> </div>
        </div>
        ...
        foreach($album as $albumname){
            ...
            echo 
            "<div class='col-md-3'>                
                <img src='images/". $json['thumbnail']['thumbnail'] ."'>
                <div class='caption' data-album='". $albumname ."'>
                    <h2>". $albumname ."</h2>
